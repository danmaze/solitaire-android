...
public class Layout {
    ...
    public final Point cardRadius = new Point();    // The rectangle radius for the card rectangles
    ...
    public void initLayout(final int width, final int height, Settings settings) {
        ...
        if (layout.viewOrientation == Layout.HORIZONTAL) {
            ...
            layout.gameSize.x =
                    (int) (11.5 * layout.cardSize.x + 2 * layout.cardSpacingBig.x + 8 * layout.cardSpacing.x);
            ...
            if (!settings.leftHand) {
                ...
                tableauLoc.x =
                        (int) (foundationsLoc.x + 1.5 * layout.cardSize.x) + layout.cardSpacingBig.x;
                tableauLoc.y = foundationsLoc.y;

                gameDeckLoc.x = foundationsLoc.x + gameSize.x - cardSize.x;
                gameDeckLoc.y = foundationsLoc.y;
                /* sourcesLoc.x =
                        foundationsLoc.x + 8 * layout.cardSize.x + 6 * layout.cardSpacing.x + 2
                ...
                tableauLoc.x =
                        (int) (foundationsLoc.x - cardSpacingBig.x - 7.5 * cardSize.x - 6 * cardSpacing.x);
